...
export default function Contact() {
  ...
  return (
    <main className="pt-20 min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 selection:bg-emerald-200 selection:text-emerald-900">
      ...
      {/* HERO SECTION */}
      <section className="relative h-64 md:h-72 lg:h-1/4 overflow-hidden">
        <motion.img
          src={hero}
          ...
          >
            ...
            <div className="mt-6">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-3 px-4 py-2 bg-rose-500 text-white rounded-lg font-semibold shadow hover:scale-[1.02] transition-transform"
              >
                Follow on Instagram
              </a>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <div className="flex items-center gap-4">
                  <button
                    type="submit"
                    className="px-6 py-3 bg-rose-500 text-white rounded-lg font-semibold shadow hover:scale-[1.02] transition disabled:opacity-60"
