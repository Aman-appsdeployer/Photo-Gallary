...
export default function About() {
  ...
  return (
    ...
    >
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            >
              <a
                href="/contact"
                className="px-6 py-3 bg-gradient-to-r from-emerald-300 to-rose-500 text-gray-900 rounded-full font-semibold shadow-2xl hover:scale-[1.02] transform transition-all"
              >
                Book a Session
              </a>
              <a
      ...
      {/* CTA */}
      <section className="py-16 bg-gradient-to-r from-emerald-400 to-rose-500 text-white">
