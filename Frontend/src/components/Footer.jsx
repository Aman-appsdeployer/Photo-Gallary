      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col items-center  text-center text-white gap-10">
          ...
          <div className="flex gap-8">
            <a
              ...
              className="text-rose-500 hover:text-primary-foreground transition"
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-3 lg:flex lg:justify-center gap-10 text-base font-poppins text-center">
          <a
            ...
            className={`${isActive("/") ? "text-rose-500 font-bold" : "text-white hover:text-rose-500"}`}
          >
            Home
          </a>
          ...
          <a
            ...
            className={`${isActive("/about") ? "text-rose-500 font-bold" : "text-white hover:text-rose-500"}`}
          >
            About
          </a>
          ...
          <a
            ...
            className={`${isActive("/contact") ? "text-rose-500 font-bold" : "text-white hover:text-rose-500"}`}
          >
            Contact Us
          </a>
          <a 
            href="/our-product"
            onClick={(e) => handleNavigate(e, "/our-product")}
            className={`${isActive("/our-product") ? "text-rose-500 font-bold" : "text-white hover:text-rose-500"}`}
          >
            Our Product
          </a>
