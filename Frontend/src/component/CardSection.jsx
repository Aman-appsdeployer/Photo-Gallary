...
export default function CardSection() {
  ...
  return (
    <section ref={containerRef} className="py-10 lg:-mt-32">
      ...
      <div className="p-4">
        ...
        <div className="mt-4">
          <button
            ...
            onKeyDown={onKeyCTA}
            className="inline-block text-sm px-4 py-2 rounded-full bg-rose-500 text-white hover:bg-rose-500 shadow-sm"
          >
            View Gallery
          </button>
        </div>
