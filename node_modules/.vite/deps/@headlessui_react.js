  ...
  let pressProps = (0, import_react25.useMemo)(() => {
      ...
      onClick(e7) {
        ...
        if (e7 && e7.button === 0 && !state.isTriggeringEvent && !(0, $ea8dcbcb9ea1b556$export$95185d699e05d4d7).isOpening) {
          ...
          if (!state.ignoreEmulatedMouseEvents && !state.isPressed && (state.pointerType === "virtual" || (0, $6a7db85432448f7f$export$60278871457622de)(e7.nativeEvent))) {
            ...
            let stopPressUp = triggerPressUp($f6c31cce2adf654f$var$createEvent(e7.currentTarget, e7), pointerType);
            let stopPressEnd = triggerPressEnd($f6c31cce2adf654f$var$createEvent(e7.currentTarget, e7), pointerType, true);
    ...
    if (typeof PointerEvent !== "undefined") {
      ...
      pressProps2.onPointerUp = (e7) => {
        ...
        if (e7.button === 0 && !state.isPressed) triggerPressUp(e7, state.pointerType || e7.pointerType);
      };
      ...
      pressProps2.onMouseUp = (e7) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e7.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e7.nativeEvent))) return;
        if (!state.ignoreEmulatedMouseEvents && e7.button === 0 && !state.isPressed) triggerPressUp(e7, state.pointerType || "mouse");
      };
      let onMouseUp = (e7) => {
...
var approxEqual = (a19, b7) => Math.abs(a19 - b7) < 1.01;
  ...
  constructor(opts) {
    ...
    this.getMeasurements = memo(
      ...
      ({ count: count2, paddingStart, scrollMargin, getItemKey, enabled, lanes }, itemSizeCache) => {
        ...
        for (let m11 = 0; m11 < min2; m11++) {
          const item = measurements[m11];
          if (item) {
            laneLastIndex[item.lane] = m11;
          }
        }
